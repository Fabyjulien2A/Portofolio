        ...
        <ul class="socials list-unstyled">
          ...
          <li>
            <a href="espace-admin\connexion.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="1em" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
