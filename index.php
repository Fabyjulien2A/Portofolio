          ...
          <div class="container d-flex">
            ...
            <div class="right">
              <ul class="socials list-unstyled">
                ...
                <li>
                  <a href="https://twitter.com/julien_faby" target="_blank">
                ...
                <li>
                  <a href="https://www.instagram.com/julienfaby/" target="_blank">
                ...
                <li>
                  <a href="https://github.com/Fabyjulien2A" target="_blank">
          ...
          <div class="container">
            ...
            <div class="grid">
                ...
                <div class="service">
                  <div class="service__icon">
                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="check-square"
                      class="svg-inline--fa fa-check-square fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512">
                      <path fill="currentColor"
              ...
              <div class="grid__item">
                ...
                <div class="service">
                  <div class="service__icon">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-cog"
                      class="svg-inline--fa fa-user-cog fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 512">
                      <path fill="currentColor"
          ...
          <div class="container">
            ...
            <div class="grid">
              ...
              <div class="grid__item">
                ...
                <div class="progressbar">
                  <div class="bar" data-width="75">FIGMA</div>
                </div>
              </div>
            </div>
          </div>
